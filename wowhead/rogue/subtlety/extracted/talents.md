...
Tab Group 0: ['Trickster', 'Deathstalker']
Tab Group 1: ['Trickster']
...
Encounters with AoE (in addition to Adds/Cleave):  Weaponmaster →  Finality.
...
There are only a few adjustments you can make to delve content. The list below highlights some potential talent swaps.
