...
Tab Group 0: ['Slayer', 'Colossus']
Tab Group 1: ['Colossus', 'Slayer']
...
The single target  Slayer build gains increased  Sudden Death procs through  Imminent Demise and focuses on  Bladestorm as its secondary cooldown.
 Sweeping Strikes and  Bladestorm handle most multitarget requirements, so Arms generally focuses on full single target damage in raid encounters. Extra two-target cleave can be gained by talenting into  Broad Strokes and/or  Powerful Momentum, though going full into multitarget talents is not generally recommended.
 Further Details
...
The single target  Colossus build plays very similarly to Slayer, with more emphasis on Mortal Strike to facilitate  Demolish.
 Sweeping Strikes and  Demolish handle most multitarget requirements, so Arms generally focuses on full single target damage in raid encounters. Extra two-target cleave can be gained by talenting into  Broad Strokes and/or  Powerful Momentum, though going full into multitarget talents is not generally recommended.
 Ravager now serves as a vehicle to buff Cleave, so it will not be taken in most raid content.
 Further Details
