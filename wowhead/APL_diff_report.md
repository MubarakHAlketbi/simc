...
| 1 | Outbreak | `outbreak` | ✓ MATCH | Present in APL (pos ~7) |
| 2 | Festering Strike | `festering_strike` | ~ ORDER_DIFF | APL pos ~2, previous item at pos ~7 (Wowhead order reversed vs APL) |
| 3 | Soul Reaper | `soul_reaper` | ✓ MATCH | Present in APL (pos ~10) |
| 4 | Army of the Dead | `army_of_the_dead` | ✓ MATCH | Present in APL (pos ~8) |
| 5 | Dark Transformation | `dark_transformation` | ✓ MATCH | Present in APL (pos ~9) |
| 6 | Putrefy | `putrefy` | ✓ MATCH | Present in APL (pos ~6) |
| 7 | Festering Scythe | `festering_scythe` | ✗ MISSING | Not found in SimC APL |
| 8 | Death Coil | `death_coil` | ✓ MATCH | Present in APL (pos ~4) |
| 9 | Scourge Strike | `scourge_strike` | ✓ MATCH | Present in APL (pos ~5) |
| 10 | Necrotic Coil | `death_coil` | ✓ MATCH | Present in APL (pos ~4) |
| 11 | Vampiric Strike | `vampiric_strike` | ✗ MISSING | Not found in SimC APL |
...
| 1 | Outbreak | `outbreak` | ✓ MATCH | Present in APL (pos ~7) |
| 2 | Festering Strike | `festering_strike` | ~ ORDER_DIFF | APL pos ~2, previous item at pos ~7 (Wowhead order reversed vs APL) |
| 3 | Army of the Dead | `army_of_the_dead` | ✓ MATCH | Present in APL (pos ~8) |
| 4 | Dark Transformation | `dark_transformation` | ✓ MATCH | Present in APL (pos ~9) |
| 5 | Putrefy | `putrefy` | ✓ MATCH | Present in APL (pos ~6) |
| 6 | Festering Scythe | `festering_scythe` | ✗ MISSING | Not found in SimC APL |
| 7 | Epidemic | `epidemic` | ✓ MATCH | Present in APL (pos ~3) |
| 8 | Scourge Strike | `scourge_strike` | ✓ MATCH | Present in APL (pos ~5) |
| 9 | Graveyard | `graveyard` | ✗ MISSING | Not found in SimC APL |
...
- **4 unique MISSING** actions and 6 ORDER_DIFF items
- Top priority gaps:
  ...
  1. [Single-Target Priority] `festering_strike` (Festering Strike) - ORDER_DIFF
- **Recommended**: Review and add missing major CDs/rotational abilities to APL
...
| # | Wowhead Action | SimC Name | Status | Notes |
|---|----------------|-----------|--------|-------|
| 1 | Moonfire | `moonfire` | ✓ MATCH | Present in APL (pos ~13) |
| 2 | Red Moon | `red_moon` | ✗ MISSING | Not found in SimC APL |
| 3 | Mangle | `mangle` | ✓ MATCH | Present in APL (pos ~16) |
...
|---|----------------|-----------|--------|-------|
| 1 | Moonfire | `moonfire` | ✓ MATCH | Present in APL (pos ~13) |
| 2 | Mangle | `mangle` | ✓ MATCH | Present in APL (pos ~16) |
...
| 3 | Thrash | `thrash_cat` | ✗ MISSING | Not found in SimC APL |
| 4 | Frenzied Regeneration | `frenzied_regeneration` | ✗ MISSING | Not found in SimC APL |
| 5 | Moonfire | `moonfire` | ✓ MATCH | Present in APL (pos ~13) |
| 6 | Swipe | `swipe_cat` | ✗ MISSING | Not found in SimC APL |
...
| `heart_of_the_wild` | Sim-specific logic not covered by guide |
| `incarnation` | Sim-specific logic not covered by guide |
| `berserk` | Sim-specific logic not covered by guide |
| `convoke_the_spirits` | Sim-specific logic not covered by guide |
| `lunar_beam` | Sim-specific logic not covered by guide |
| `barkskin` | Sim-specific logic not covered by guide |
| `bristling_fur` | Sim-specific logic not covered by guide |
| `ironfur` | Sim-specific logic not covered by guide |
| `raze` | Sim-specific logic not covered by guide |
...
| `engulf` | Sim-specific logic not covered by guide |
...
| # | Wowhead Action | SimC Name | Status | Notes |
|---|----------------|-----------|--------|-------|
| 1 | Prescience | `prescience` | ✓ MATCH | Present in APL (pos ~17) |
| 2 | Ebon Might | `ebon_might` | ✓ MATCH | Present in APL (pos ~16) |
| 3 | Fire Breath | `fire_breath` | ~ ORDER_DIFF | APL pos ~6, previous item at pos ~16 (Wowhead order reversed vs APL) |
| 4 | Upheaval | `upheaval` | ✓ MATCH | Present in APL (pos ~20) |
| 5 | Eruption | `eruption` | ✓ MATCH | Present in APL (pos ~22) |
| 6 | Living Flame | `living_flame` | ~ ORDER_DIFF | APL pos ~1, previous item at pos ~22 (Wowhead order reversed vs APL) |
| 7 | Azure Strike | `azure_strike` | ✓ MATCH | Present in APL (pos ~12) |
| 8 | Blistering Scales | `blistering_scales` | ~ ORDER_DIFF | APL pos ~0, previous item at pos ~12 (Wowhead order reversed vs APL) |
...
| # | Wowhead Action | SimC Name | Status | Notes |
|---|----------------|-----------|--------|-------|
| 1 | Ebon Might | `ebon_might` | ✓ MATCH | Present in APL (pos ~16) |
| 2 | Prescience | `prescience` | ✓ MATCH | Present in APL (pos ~17) |
| 3 | Breath of Eons | `breath_of_eons` | ✓ MATCH | Present in APL (pos ~19) |
| 4 | Eruption | `eruption` | ✓ MATCH | Present in APL (pos ~22) |
...
| # | Wowhead Action | SimC Name | Status | Notes |
|---|----------------|-----------|--------|-------|
| 1 | Arcane Orb | `arcane_orb` | ✓ MATCH | Present in APL (pos ~12) |
| 2 | Arcane Barrage | `arcane_barrage` | ✓ MATCH | Present in APL (pos ~10) |
| 3 | Presence of Mind | `presence_of_mind` | ✓ MATCH | Present in APL (pos ~15) |
| 4 | Arcane Blast | `arcane_blast` | ~ ORDER_DIFF | APL pos ~4, previous item at pos ~15 (Wowhead order reversed vs APL) |
...
### Hero: Spellslinger Missile Build
...
- Top priority gaps:
  1. [Opener] `group_buffs` (Group Buffs) - MISSING
  1. [Single-Target Priority] `arcane_blast` (Arcane Blast) - ORDER_DIFF
  1. [Single-Target Priority] `arcane_pulse` (Arcane Pulse) - ORDER_DIFF
  1. [Single-Target Priority] `arcane_pulse` (Arcane Pulse) - ORDER_DIFF
- **Recommended**: Review and add missing major CDs/rotational abilities to APL
...
| 2 | Breath of Fire | `breath_of_fire` | ~ ORDER_DIFF | APL pos ~3, previous item at pos ~11 (Wowhead order reversed vs APL) |
| 3 | Exploding Keg | `exploding_keg` | ✓ MATCH | Present in APL (pos ~7) |
| 4 | Chi Burst | `chi_burst` | ✓ MATCH | Present in APL (pos ~6) |
...
| 1 | Blackout Kick | `blackout_kick` | ✓ MATCH | Present in APL (pos ~11) |
| 2 | Breath of Fire | `breath_of_fire` | ~ ORDER_DIFF | APL pos ~3, previous item at pos ~11 (Wowhead order reversed vs APL) |
| 3 | Chi Burst | `chi_burst` | ✓ MATCH | Present in APL (pos ~6) |
| 4 | Exploding Keg | `exploding_keg` | ✓ MATCH | Present in APL (pos ~7) |
| 5 | Spinning Crane Kick | `spinning_crane_kick` | ✓ MATCH | Present in APL (pos ~22) |
...
- **2 unique MISSING** actions and 10 ORDER_DIFF items
- Top priority gaps:
  ...
  1. [Single-Target Priority] `breath_of_fire` (Breath of Fire) - ORDER_DIFF
  1. [AoE Priority] `breath_of_fire` (Breath of Fire) - ORDER_DIFF
...
| # | Wowhead Action | SimC Name | Status | Notes |
|---|----------------|-----------|--------|-------|
| 1 | Touch of Death | `touch_of_death` | ✓ MATCH | Present in APL (pos ~21) |
| 2 | Whirling Dragon Punch | `whirling_dragon_punch` | ~ ORDER_DIFF | APL pos ~13, previous item at pos ~21 (Wowhead order reversed vs APL) |
| 3 | Tiger Palm | `tiger_palm` | ✓ MATCH | Present in APL (pos ~15) |
| 4 | Fists of Fury | `fists_of_fury` | ✓ MATCH | Present in APL (pos ~17) |
| 5 | Rushing Wind Kick | `rushing_wind_kick` | ✓ MATCH | Present in APL (pos ~19) |
| 6 | Spinning Crane Kick | `spinning_crane_kick` | ✓ MATCH | Present in APL (pos ~16) |
| 7 | Rising Sun Kick | `rising_sun_kick` | ✓ MATCH | Present in APL (pos ~20) |
| 8 | Blackout Kick | `blackout_kick` | ~ ORDER_DIFF | APL pos ~14, previous item at pos ~20 (Wowhead order reversed vs APL) |
...
| 2 | Zenith | `zenith` | ✓ MATCH | Present in APL (pos ~27) |
| 3 | Fists of Fury | `fists_of_fury` | ~ ORDER_DIFF | APL pos ~17, previous item at pos ~27 (Wowhead order reversed vs APL) |
| 4 | Rising Sun Kick | `rising_sun_kick` | ✓ MATCH | Present in APL (pos ~20) |
| 5 | Whirling Dragon Punch | `whirling_dragon_punch` | ~ ORDER_DIFF | APL pos ~13, previous item at pos ~20 (Wowhead order reversed vs APL) |
...
- **1 unique MISSING** actions and 12 ORDER_DIFF items
- Top priority gaps:
  1. [Single-Target Priority] `tiger_palm_if_not_enough_chi` (Tiger Palm If not enough Chi) - MISSING
  1. [Single-Target Priority] `whirling_dragon_punch` (Whirling Dragon Punch) - ORDER_DIFF
  1. [Single-Target Priority] `blackout_kick` (Blackout Kick) - ORDER_DIFF
  1. [AoE Priority] `whirling_dragon_punch` (Whirling Dragon Punch) - ORDER_DIFF
- **Recommended**: Review and add missing major CDs/rotational abilities to APL
...
| # | Wowhead Action | SimC Name | Status | Notes |
|---|----------------|-----------|--------|-------|
| 1 | Hammer of Light | `hammer_of_light` | ✓ MATCH | Present in APL (pos ~5) |
| 2 | Avenging Wrath | `avenging_wrath` | ✓ MATCH | Present in APL (pos ~4) |
| 3 | Final Verdict | `final_verdict` | ✗ MISSING | Not found in SimC APL |
| 4 | Wake of Ashes | `wake_of_ashes` | ✓ MATCH | Present in APL (pos ~8) |
| 5 | Divine Toll | `divine_toll` | ✓ MATCH | Present in APL (pos ~9) |
| 6 | Blade of Justice | `blade_of_justice` | ✓ MATCH | Present in APL (pos ~10) |
| 7 | Hammer of Wrath | `hammer_of_wrath` | ✓ MATCH | Present in APL (pos ~11) |
| 8 | Judgment | `judgment` | ✓ MATCH | Present in APL (pos ~12) |
...
| 1 | Hammer of Light | `hammer_of_light` | ✓ MATCH | Present in APL (pos ~5) |
| 2 | Avenging Wrath | `avenging_wrath` | ✓ MATCH | Present in APL (pos ~4) |
| 3 | Divine Storm | `divine_storm` | ✓ MATCH | Present in APL (pos ~6) |
| 4 | Wake of Ashes | `wake_of_ashes` | ✓ MATCH | Present in APL (pos ~8) |
| 5 | Divine Toll | `divine_toll` | ✓ MATCH | Present in APL (pos ~9) |
| 6 | Blade of Justice | `blade_of_justice` | ✓ MATCH | Present in APL (pos ~10) |
| 7 | Hammer of Wrath | `hammer_of_wrath` | ✓ MATCH | Present in APL (pos ~11) |
...
| 4 | Wake of Ashes | `wake_of_ashes` | ✓ MATCH | Present in APL (pos ~8) |
| 5 | Divine Toll | `divine_toll` | ✓ MATCH | Present in APL (pos ~9) |
| 6 | Hammer of Wrath | `hammer_of_wrath` | ✓ MATCH | Present in APL (pos ~11) |
| 7 | Blade of Justice | `blade_of_justice` | ✓ MATCH | Present in APL (pos ~10) |
| 8 | Judgment | `judgment` | ✓ MATCH | Present in APL (pos ~12) |
...
- **4 unique MISSING** actions and 3 ORDER_DIFF items
- Top priority gaps:
...
| `summon_darkglare` | Sim-specific logic not covered by guide |
| *(+15 more)* | |
...
- APL well-aligned with Wowhead guide (35 action matches)
- 28 extra sim-specific actions in APL (expected)
