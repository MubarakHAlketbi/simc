...
This guide provides relevant information about your Augmentation Evoker tier, including how the tier bonuses work, their effect on the Augmentation Evoker playstyle, how to acquire tier set pieces, and what gearing strategy you should be using.
Overview
BiS Gear
Rotation
Talent Builds
...
Report ad
Remove All Ads
 TIER SET BONUSES FOR AUGMENTATION EVOKER
...
The 2pc set bonus increases damage dealt by  Eruption, while also increasing the amount of Ebon Might extension provided. Not only does this effect directly improve ebon Might uptime, but this additional extension also applies to  Duplicate, making this 2pc bonus particularly impactful.

The 4pc set bonus increases damage dealt by Empower spells  Fire Breath and  Upheaval while also reducing their cooldowns. This achieves a similar overall result to the 2pc bonus, increasing both personal damage dealt while making Ebon Might and Duplicate extension available more frequently, improving uptime of these two effects. The condition on Ebon Might being active reinforces the goals of the spec, as Empower spells should already only be cast while Ebon Might is active, and maximizing uptime of Ebon Might is essential.
...
To unlock the tier set bonus, you'll need to equip 4 pieces of the tier set. Due to their itemization, Augmentation Evoker prefer equipping tier pieces on these slots:
Helm
Shoulders
Chest
Legs
Ideally, you'll have Helm as your off-piece in a fully best-in-slot setup. Both Helm and Legs have a heavy allocation to Mastery, while Augmentation in Season 1 seeks to heavily prioritize Critical Strike and Haste. Prioritizing Intellect on your gear remains a top priority, and these considerations generally come into play somewhat later in the season when you can afford to be selective. As always, consider simulating your character for additional guidance on individual upgrades.
Tier Set Bonus Rotation Changes for Augmentation Evoker
...
Augmentation Evoker Talent Builds Guide
 HOW TO ACQUIRE YOUR AUGMENTATION EVOKER TIER SET BONUS IN MIDNIGHT SEASON 1
