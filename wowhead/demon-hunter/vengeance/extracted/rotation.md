...
Annihilator
Aldrachi Reaver
 Annihilator in single target puts a major focus on building procs of  Voidfall through casts of  Fracture and then spending them.
...
Focused Cleave
PRIORITY
Use  Infernal Strike off GCD if you are at or near 2 charges and will not need it for movement soon.
...
Use  Felblade if you won't cap Fury.
Use  Throw Glaive for filler or when kiting.
 ANNIHILATOR NOTES
Your general goal in single-target is to avoid wasting cooldowns, Fury, or Souls at any point. This means you should be using all cooldowns whenever available, then building and spending Souls when you can, then dumping the remaining Fury.
 Voidfall stacks will naturally be spent in a cycle, but that can be thrown off by  Metamorphosis usage. Try to hold  Metamorphosis for a few seconds if the meteor animations are still occurring due to a bug with  Mass Acceleration.
Try to enter  Metamorphosis with maximum Souls to take advantage of  Spirit Bomb reset.
...
Annihilator
Aldrachi Reaver
AoE allows for more resource generation, but our priorities tend to remain the same.
Use the ✖ markers to switch to common alternate talent picks based on your loadout.
The build options used below are covered in the Talents page. Swaps not included should not change the priority in any meaningful way unless covered elsewhere. Anywhere you see the  icon, you can hover over it for additional notes.
...
Use  Infernal Strike off GCD if you are at or near 2 charges and will not need it for movement soon.
Use  Metamorphosis if you will not overcap duration and  Spirit Bomb has more than 10s remaining on its CD.
Use  Fracture at or near 2 charges.
Use  Spirit Bomb with 4+ Souls if  Fiery Brand is about to run out.
Use  Fiery Brand if the debuff is not currently active.
Use  Spirit Bomb with 6 Souls.
Use  Immolation Aura.
Use  Sigil of Flame.
Use  Sigil of Spite if you will not cap Souls.
Use  Felblade if you have 6 Souls but not enough Fury to  Spirit Bomb.
Use  Fel Devastation if you have at least 50 Fury.
Spend Fury and any available Souls with  Soul Cleave.
Use  Fracture if you won't cap Souls.
Use  Felblade if you won't cap Fury.
Use  Throw Glaive for filler or when kiting.
 ANNIHILATOR NOTES
The AoE rotation is nearly the same as the ST rotation, but  Fel Devastation has slightly higher priority.
 Annihilator effects are primarily passive, so there is very little difference.
...
AoE Situation
SEQUENCE
Precast  Sigil of Flame in single-target or on a single pack.
 Infernal Strike into the enemy (or edge of enemies if there are multiple).
Use  Spirit Bomb as you  Infernal Strike in if you have Souls and Fury saved from the previous pull.
Use  Immolation Aura.
Use  Fracture to generate Souls and Fury.
Use  Fiery Brand for Fire damage buff.
Use  Sigil of Spite.
Use  Spirit Bomb with 6 Souls.
Use  Felblade to generate Fury if you don't have enough.
Fully channel  Fel Devastation for Souls.
Use  Metamorphosis once enemies are grouped.
Use  Fracture until you are at 6 Souls.
Use  Spirit Bomb with 6 Souls.
Use  Soul Cleave with 0 Souls.
Continue to Main Rotation.
SAMPLE TIMELINE
Precast on ST or single pack
with Souls saved
if needed
<6 Souls
 ANNIHILATOR NOTES
We are simply trying to get all our cooldowns rolling quickly before going into the Main rotation.
...
#### Pre-Combat Checks
PRE-COMBAT CHECK
Before any combat happens, it is important for Vengeance Demon Hunters to make sure the following are done. This applies to raids, dungeons, delves, or even open-world content.

Use your Consumables - Food, Flasks, Oils.
...
Annihilator
Aldrachi Reaver
 Aldrachi Reaver focuses on building and spending  Soul Fragment to gain  Art of the Glaive procs.
Use the ✖ markers to switch to common alternate talent picks based on your loadout.
The build options used below are covered in the Talents page. Swaps not included should not change the priority in any meaningful way unless covered elsewhere. Anywhere you see the  icon, you can hover over it for additional notes.
...
Use  Metamorphosis.
Use  Fracture if you are at or near 2 charges.
Use  Fracture with  Rending Strike on your priority target to proc  Reaver's Mark as well as generate Souls and Fury.
Use  Spirit Bomb with 4+ Souls if  Fiery Brand is about to run out.
Use  Fiery Brand if the debuff is not currently active.
Use  Spirit Bomb with 6 Souls.
...
Your general goal in single-target is to avoid wasting cooldowns, Fury, or Souls at any point. This means you should be using all cooldowns whenever available, then building and spending Souls when you can, then dumping the remaining Fury.
In case of any conflict, Soul generation takes priority over everything else.
Uptime is critical due to the constant flow of glaives maintaining buffs.
...
Annihilator
Aldrachi Reaver
AoE for  Aldrachi Reaver largely comes down to landing  Fury of the Aldrachi on as many targets as possible along with doing the rotation properly.
Use the ✖ markers to switch to common alternate talent picks based on your loadout.
The build options used below are covered in the Talents page. Swaps not included should not change the priority in any meaningful way unless covered elsewhere. Anywhere you see the  icon, you can hover over it for additional notes.
...
Use  Throw Glaive for filler or when kiting.
 ALDRACHI REAVER NOTES
The AoE rotation is essentially the same as the ST rotation with the priority of  Fel Devastation slightly moved up.
It is more critical as  Aldrachi Reaver to constantly be generating Souls since  Fury of the Aldrachi deals so much of the AoE damage.
...
Use  Spirit Bomb as you  Infernal Strike in if you have Souls and Fury saved from the previous pull.
Use  Immolation Aura.
Use  Sigil of Spite to activate  Art of the Glaive.
Use  Reaver's Glaive to activate the  Rending Strike and  Glaive Flurry buffs.
Use  Fracture with  Rending Strike on your priority target to proc  Reaver's Mark as well as generate Souls and Fury.
Use  Soul Cleave with  Glaive Flurry to proc  Fury of the Aldrachi and trigger  Thrill of the Fight.
Use  Fiery Brand for Fire damage buff.
Use  Metamorphosis once enemies are grouped.
Use  Felblade to generate Fury if you don't have enough.
Use  Fracture if you aren't at 6 Souls.
Use  Spirit Bomb with 6 Souls.
...
<6 Souls
 ALDRACHI REAVER NOTES
We want to get our first glaive combo out as quickly as possible and then continue into the standard rotation.
