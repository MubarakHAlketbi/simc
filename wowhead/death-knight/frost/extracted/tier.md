...
This guide provides relevant information about your Frost Death Knight tier, including how the tier bonuses work, their effect on the Frost Death Knight playstyle, how to acquire tier set pieces, and what gearing strategy you should be using.
Overview
BiS Gear
Rotation
Talent Builds
...
The Season 1 set bonus is simple for Frost. It gives us another use of a resource generator during cooldowns, but it does not affect our talents, nor does it require learning any rotational changes.
...
Chest
Gloves
Ideally, you'll have Shoulders as your off-piece, as the tier option is poorly itemized for Frost Death Knight.
This is only a minor optimization; wearing five pieces of the tier is fine if you don't have a high item-level alternative. Fully Best-In-Slot setups will often choose to replace the Chest piece instead. There are many options for gearing on Frost, and we urge players to simulate to get more accurate answers.
Tier Set Bonus Rotation Changes for Frost Death Knight
...
Frost Death Knight Talent Builds Guide
 HOW TO ACQUIRE YOUR FROST DEATH KNIGHT TIER SET BONUS IN MIDNIGHT SEASON 1
