...
public:
  ...
  struct talents_t
  {
    struct class_talents_t
    {
      ...
      // TODO: Midnight info_base lists "Champion" (ID:376079) as a separate class talent node.
      //   Verify whether this is a prereq gate node or a distinct DPS talent in Midnight.
