...
HowToBuild
Serge Camille edited this page on Aug 20, 2022 · 53 revisions
Table of Contents
...
Graphical User Interface / Qmake builds
    ...
    If you receive an error from Qmake such as Project ERROR: Could not resolve SDK path for 'macosx10.9', you will need to explicitly tell make what OS X SDK to use, for example qmake QMAKE_MAC_SDK=macosx<version> simulationcraft.pro, where is your OS X version (e.g., 10.10, 10.11). Note that the "OS X" version here is at least partly determined by your Xcode version, and may not match 1:1 with your operating system version.
...
Adding directory to PATH
    ...
    On Windows7 go to Control Panel -> System -> Advanced system settings -> Environment Variables
        ...
        For other versions of windows, see http://www.computerhope.com/issues/ch000549.htm.

GNU Make Options

* Add -j n  where n is the number of threads used for compiling
* The GCC flag -dM will stop the compiler after the preprocessing pass and make it dump all #defin
